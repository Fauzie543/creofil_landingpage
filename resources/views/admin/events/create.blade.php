    ...
    <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input name="start_time" type="datetime-local" value="{{ old('start_time') }}" class="form-control"
                    required>
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label">Waktu Selesai</label>
                <input name="end_time" type="datetime-local" value="{{ old('end_time') }}" class="form-control"
                    required>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input name="location" value="{{ old('location') }}" class="form-control" required>
        </div>
